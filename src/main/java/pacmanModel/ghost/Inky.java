...
public class Inky extends Ghost {
	 ...
	 *
	 */
	public Inky(PacmanBoard pacmanBoard, Position position) {
		super(pacmanBoard, position, new ImageIcon(ClassLoader.getSystemClassLoader().getResource("Inky.png")));
	}
	/***
	 * Inky's getDestination tries to move in front of where the player is heading. During hunting mode he moves to the upper left corner
	 */
	@Override
